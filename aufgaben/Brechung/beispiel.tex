...
%$c_2=2 \cdot c_1 \qquad a=1 \qquad b=2a \qquad d=1 \qquad \frac{1}{c2 \Sqrt{b^2 + (d - x)^2}} - \frac{(d - x)^2 }{c2 (b^2 + (d - x)^2)^(3/2)} - \frac{x^2}{c1 (a^2 + x^2)^(3/2)}$
%$ + \frac{1}{c1 \Sqrt{1^2 + x^2}} = y  \qquad   x_0 = 0.190898 y =\frac{1.14688}{c1} > 0$ minimum da einzige extremal punkt kandidat auch globales
