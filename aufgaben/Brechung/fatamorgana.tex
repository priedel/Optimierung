...
Die Euler-Lagrange-Gleichung wird gleich wie in \secref{sec:Krümmung} berechnet. Bei \eqref{lagrange4} wird weiter gerechnet. In (\eqref{lagrang4repet}) werden alle Terme auf die linke Seite genommen.
\begin{align}
