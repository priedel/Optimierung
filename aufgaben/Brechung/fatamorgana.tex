...
Um dieses Minimalproblem zu lösen, wird die allgemeine Euler-Lagrange-Gleichung \chapref{chapter-variationsrechnung} \eqref{lagrange-integral} des Variationsproblems aufgestellt (\eqref{krümmung}).
