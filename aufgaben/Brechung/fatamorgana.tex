\section{Fata Morgana und Berechnungen mittels Euler-Lagrange Gleichung}
...
Daraus kann die verallgemeinerte Schlussfolgerung gezogen werden, dass der Lichtstrahl konkav sein muss, wenn die Funktion $g(x)$ monoton \texttodo{nur fallend?} fallend ist. 
